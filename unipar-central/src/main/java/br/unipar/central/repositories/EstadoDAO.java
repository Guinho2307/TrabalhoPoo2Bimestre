...
public class EstadoDAO {
    ...
    public void update(Estado estado) throws SQLException {
        ...
        try {
            ...
            pstmt.setInt(4, estado.getPais().getIdAbst());
            pstmt.setInt(5, estado.getIdAbst());
